...
io.on("connection", (socket) => {
  ...
  const updateInput = (payload) => {
    try {
      ...
      // Prevent map2 geometry jitter when clients have different viewport heights.
      // Only the host's reported height can update world2 runtime height.
      if (room.world === 2 && room.hostId === playerId) {
...
//sadasdsadasdasdasdsadsadsadsad
